...
def main():
    ...
    # better_draw_circles(rg.Point(100, 0), 10)
    # better_draw_circles(rg.Point(-200, 0), 7)
    even_better_draw_circles(rg.Point(100,0), 15, 10, 'red', 6)
    even_better_draw_circles(rg.Point(-200,40), 20, 30, 'blue', 3)
...
#   it has a single additional PARAMETER that is the amount by which the radii of the
...
def even_better_draw_circles(point, r, c, color, thick):
    ...
    for k in range(1, (c+1)):  # k becomes 1, 2, 3, ... 10
